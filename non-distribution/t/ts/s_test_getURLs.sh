...
URL="http://distributed.com/folder/index.html"
INPUT_FILE=$T_FOLDER/$DS_FOLDER/d10.txt
EXPECTED_OUTPUT_FILE=$T_FOLDER/$DS_FOLDER/d11.txt
...
if $DIFF <(cat "$INPUT_FILE" | c/getURLs.js $URL) <(cat "$EXPECTED_OUTPUT_FILE") >&2;
then
