...
/* Come up with an object that uses all valid (serializable)
  ...
  let object = {
    str: "Hello, Nikos!",  // string
    num: 77,               // number
    bool: true,            // boolean
    nul: null,             // null
    undef: undefined,      // undefined
    obj: { armaan: "patankar" }, // Object
    arr: [4, 2, 0],        // Array
    date: new Date("2025-02-02"), // Date
    err: new Error("Distributed Systems"), // Error
    func: function (x) { return x + 1; }, // Function
  };
...
/* Come up with a string that is not a valid serialized object. */
  ...
  let malformedSerializedString = "{type: number, value: 1}";
